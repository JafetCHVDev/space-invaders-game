...
use soroban_sdk::{contract, contractimpl, Env, Vec, Address, String};
...
pub use game_state::{
    ...
    EntityPosition, Velocity, Health, Ship, Player, LeaderboardEntry,
...
impl SpaceInvadersContract {
    ...
    pub fn submit_score(env: Env, player: Address, score: u32) -> bool {
        ...
        env.storage().persistent().set(&DataKey::Leaderboard, &new_leaderboard);
